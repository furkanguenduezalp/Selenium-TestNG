...
/*
    <table> <thead> <tbody>
    <thead> table head with coloumn names
        <tr> indicates one whole row
            <th> indicates a cell that is used for table headers
    <tbody>
        <tr> indicates one whole row
            <td> indicates a cell in a row. index number is the column number
...
WebDriver driver;
    ...
    public void getCellInRelationToAnotherCellInSameRow(){
        ...
        String xpath = "//table[@id='table1']/tbody//td[.='"+firstName+"']/../td[3]";
