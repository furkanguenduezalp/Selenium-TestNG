...
public class ActionTest {
    ...
    public void test1() throws InterruptedException {
        ...
        //Actions --> class that contatins all the user interations
    ...
    public void dragAndDrop() throws InterruptedException {
        ...
        List<WebElement> acceptAndClose = driver.findElements(By.xpath("//button[.='Accept and Close']"));
        ...
        //html for 'accept and close', source and target don't come directly!!!
